...
class pub_sub
{
  ...
  public:
    ...
    pub_sub()
    {
      _sub = _n.subscribe("/swiftnav/front/gps_pose", 1000, &pub_sub::chatterCallback, this);
      _pub = _n.advertise<nav_msgs::Odometry>("/rechatter_front", 1);
    }
...
{
 	ros::init(argc, argv, "lla2enu_front");
 	pub_sub my_pub_sub;
 	ros::spin();
 	return 0;
}
